...
RSpec.describe "user can find item by attribute in params", type: :request do
  ...
  it "returns all records based on id" do
    ...
    transaction_1 = Transaction.create!(result: "succes", invoice_id: invoice.id, created_at: "2012-03-27T14:54:05.000Z", updated_at: "2012-03-27T14:54:05.000Z")
    transaction_2 = Transaction.create!(result: "succes", invoice_id: invoice.id, created_at: "2012-03-27T14:54:05.000Z", updated_at: "2012-03-27T14:54:05.000Z")
    transaction_3 = Transaction.create!(result: "succes", invoice_id: invoice.id, created_at: "2012-03-27T14:54:05.000Z", updated_at: "2012-03-27T14:54:05.000Z")
    transaction_4 = Transaction.create!(result: "failed", invoice_id: invoice.id, created_at: "2012-03-27T14:54:05.000Z", updated_at: "2012-03-27T14:54:05.000Z")
  ...
  it "returns all records based on updated_at date" do
    ...
    transaction_2 = Transaction.create!(result: "succes", invoice_id: invoice.id, created_at: "2012-03-27T14:54:05.000Z", updated_at: "2012-03-27T14:54:05.000Z")
    transaction_3 = Transaction.create!(result: "succes", invoice_id: invoice.id, created_at: "2012-03-27T14:54:05.000Z", updated_at: "2012-03-27T14:54:05.000Z")
    transaction_4 = Transaction.create!(result: "failed", invoice_id: invoice.id, created_at: "2012-03-27T14:54:05.000Z", updated_at: "2012-06-27T14:54:05.000Z")
